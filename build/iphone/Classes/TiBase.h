...
// in simulator we redefine to format for fringe_mobile Developer console
...
{\
	NSString * exceptionName = [@"org.fringe_mobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fringe_mobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIfringe_mobileNativeItemNone = -1, 
	UIfringe_mobileNativeItemSpinner = -2,
	UIfringe_mobileNativeItemProgressBar = -3,
	
	UIfringe_mobileNativeItemSlider = -4,
	UIfringe_mobileNativeItemSwitch = -5,
	UIfringe_mobileNativeItemMultiButton = -6,
	UIfringe_mobileNativeItemSegmented = -7,
	
	UIfringe_mobileNativeItemTextView = -8,
	UIfringe_mobileNativeItemTextField = -9,
	UIfringe_mobileNativeItemSearchBar = -10,
	
	UIfringe_mobileNativeItemPicker = -11,
	UIfringe_mobileNativeItemDatePicker = -12,
	
	UIfringe_mobileNativeItemInfoLight = -13,
	UIfringe_mobileNativeItemInfoDark = -14,
	
	UIfringe_mobileNativeItemDisclosure = -15,
	
	UIfringe_mobileNativeItemContactAdd = -16
};
