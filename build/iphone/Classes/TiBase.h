...
// in simulator we redefine to format for Stagey Developer console
...
{\
	NSString * exceptionName = [@"org.stagey." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stagey";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIStageyNativeItemNone = -1, 
	UIStageyNativeItemSpinner = -2,
	UIStageyNativeItemProgressBar = -3,
	
	UIStageyNativeItemSlider = -4,
	UIStageyNativeItemSwitch = -5,
	UIStageyNativeItemMultiButton = -6,
	UIStageyNativeItemSegmented = -7,
	
	UIStageyNativeItemTextView = -8,
	UIStageyNativeItemTextField = -9,
	UIStageyNativeItemSearchBar = -10,
	
	UIStageyNativeItemPicker = -11,
	UIStageyNativeItemDatePicker = -12,
	
	UIStageyNativeItemInfoLight = -13,
	UIStageyNativeItemInfoDark = -14,
	
	UIStageyNativeItemDisclosure = -15,
	
	UIStageyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Stagey instances of
