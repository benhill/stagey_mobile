 ...
 * Copyright (c) 2009-2011 by Stagey, Inc. All Rights Reserved.
...
//@interface StageyObject : NSObject
//@end

@interface StageyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StageyObject class]])
		{
			for (NSString *key in [[(StageyObject*)o modules] allKeys])
			{
