...
//@interface fringe_mobileObject : NSObject
//@end

@interface fringe_mobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[fringe_mobileObject class]])
		{
			for (NSString *key in [[(fringe_mobileObject*)o modules] allKeys])
			{
